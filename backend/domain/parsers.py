...
class CorruptedBookError(Exception):
    """Raised when a book file header, archive, or structure is unreadable."""

    pass


class DrmProtectedError(Exception):
    """Raised when a book file contains proprietary DRM encryption."""
...
@dataclass
class TocItem:
    """Represents an entry in the Table of Contents outline."""
...
class ParsedBookPayload:
    """Standardized payload returned by any concrete format parser."""
